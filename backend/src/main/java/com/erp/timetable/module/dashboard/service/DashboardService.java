...
public class DashboardService {
    ...
    public DashboardStatsResponse getDashboardStats() {
        ...
        // Calculate Faculty Workload dynamically
        Page<Faculty> facultyPage = facultyRepository.findAll(PageRequest.of(0, 6));
        ...
        // Calculate Room Utilization dynamically
        ...
        Page<Subject> subjectPage = subjectRepository.findAll(PageRequest.of(0, 4));
